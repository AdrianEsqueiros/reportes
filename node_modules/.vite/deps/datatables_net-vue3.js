      ...
      if (s.crossDomain || s.scriptAttrs) {
        ...
        return {
          send: function(_, complete) {
            ...
            document.head.appendChild(script2[0]);
          },
          abort: function() {
            if (callback) {
              callback();
  ...
  (function(factory) {
    {
      module.exports = function(root, $) {
        ...
        if (!$) {
          $ = typeof window !== "undefined" ? jquery : jquery(root);
        }
        return factory($, root, root.document);
      };
    }
  })(function($, window2, document, undefined$1) {
    var DataTable = function(selector, options) {
      ...
      this.fnGetData = function(src, col) {
        ...
        if (src !== undefined$1) {
          ...
          return col !== undefined$1 || type == "td" || type == "th" ? api.cell(src, col).data() : api.row(src).data() || null;
        }
        return api.data().toArray();
      };
      this.fnGetNodes = function(iRow) {
        var api = this.api(true);
        return iRow !== undefined$1 ? api.row(iRow).node() : api.rows().nodes().flatten().toArray();
      };
          ...
          $(rowOne[0]).children("th, td").each(function(i3, cell) {
            ...
            if (col.mData === i3) {
              ...
              if (sort !== null || filter !== null) {
                col.mData = {
                  _: i3 + ".display",
                  sort: sort !== null ? i3 + ".@data-" + sort : undefined$1,
                  type: sort !== null ? i3 + ".@data-" + sort : undefined$1,
                  filter: filter !== null ? i3 + ".@data-" + filter : undefined$1
                };
    ...
    DataTable.util = {
      throttle: function(fn, freq) {
        var frequency = freq !== undefined$1 ? freq : 200, last, timer;
        return function() {
        ...
        if ($.isPlainObject(source)) {
          ...
          var setData = function(data, val, src) {
            ...
            for (var i2 = 0, iLen = a.length - 1; i2 < iLen; i2++) {
              ...
              if (data[a[i2]] === null || data[a[i2]] === undefined$1) {
                data[a[i2]] = {};
              }
              data = data[a[i2]];
            }
      ...
      get: function(source) {
        if ($.isPlainObject(source)) {
          ...
          return function(data, type, row, meta) {
            var t = o[type] || o._;
            return t !== undefined$1 ? t(data, type, row, meta) : data;
          };
        } else if (source === null) {
          ...
          var fetchData = function(data, type, src) {
            ...
            if (src !== "") {
              ...
              for (var i2 = 0, iLen = a.length; i2 < iLen; i2++) {
                ...
                if (data === null || data[a[i2]] === undefined$1) {
                  return undefined$1;
                }
                data = data[a[i2]];
              }
    ...
    function _fnApplyColumnDefs(oSettings, aoColDefs, aoCols, fn) {
      ...
      if (aoColDefs) {
        for (i2 = aoColDefs.length - 1; i2 >= 0; i2--) {
          def = aoColDefs[i2];
          var aTargets = def.target !== undefined$1 ? def.target : def.targets !== undefined$1 ? def.targets : def.aTargets;
    ...
    function _fnInvalidate(settings, rowIdx, src, colIdx) {
      ...
      if (src === "dom" || (!src || src === "auto") && row.src === "dom") {
        row._aData = _fnGetRowElements(settings, row, colIdx, colIdx === undefined$1 ? undefined$1 : row._aData).data;
      } else {
    ...
    function _fnGetRowElements(settings, row, colIdx, d) {
      ...
      var cellProcess = function(cell) {
        if (colIdx === undefined$1 || colIdx === i2) {
          col = columns[i2];
      ...
      if (row.nTr === null) {
        ...
        for (i2 = 0, iLen = oSettings.aoColumns.length; i2 < iLen; i2++) {
          ...
          if (oCol.fnCreatedCell) {
            oCol.fnCreatedCell.call(oSettings.oInstance, nTd, _fnGetCellData(oSettings, iRow, i2), rowData, iRow, i2);
          }
        }
    ...
    function _fnDrawHead(oSettings, aoSource, bIncludeHidden) {
      ...
      for (i2 = 0, iLen = aoLocal.length; i2 < iLen; i2++) {
        ...
        for (j = 0, jLen = aoLocal[i2].length; j < jLen; j++) {
          iRowspan = 1;
          iColspan = 1;
          if (aApplied[i2][j] === undefined$1) {
            nLocalTr.appendChild(aoLocal[i2][j].cell);
            aApplied[i2][j] = 1;
            while (aoLocal[i2 + iRowspan] !== undefined$1 && aoLocal[i2][j].cell == aoLocal[i2 + iRowspan][j].cell) {
              aApplied[i2 + iRowspan][j] = 1;
              iRowspan++;
            }
            while (aoLocal[i2][j + iColspan] !== undefined$1 && aoLocal[i2][j].cell == aoLocal[i2][j + iColspan].cell) {
    ...
    function _fnAjaxDataSrc(oSettings, json, write) {
      var dataSrc = $.isPlainObject(oSettings.ajax) && oSettings.ajax.dataSrc !== undefined$1 ? oSettings.ajax.dataSrc : oSettings.sAjaxDataProp;
      if (!write) {
        if (dataSrc === "data") {
    ...
    function _fnFilterComplete(oSettings, oInput, iForce) {
      ...
      if (_fnDataSource(oSettings) != "ssp") {
        ...
        for (var i2 = 0; i2 < aoPrevSearch.length; i2++) {
          _fnFilterColumn(oSettings, aoPrevSearch[i2].sSearch, i2, fnRegex(aoPrevSearch[i2]), aoPrevSearch[i2].bSmart, aoPrevSearch[i2].bCaseInsensitive);
        }
    ...
    function _fnFeatureHtmlLength(settings) {
      ...
      for (var i2 = 0, ien = lengths.length; i2 < ien; i2++) {
        select[0][i2] = new Option(typeof language[i2] === "number" ? settings.fnFormatNumber(language[i2]) : language[i2], lengths[i2]);
      }
          ...
          "fn": function(settings2) {
            if (modern) {
              ...
              for (i2 = 0, ien = features.p.length; i2 < ien; i2++) {
                _fnRenderer(settings2, "pageButton")(settings2, features.p[i2], i2, buttons, page, pages);
              }
            } else {
    ...
    function _fnSortFlatten(settings) {
      var i2, k, kLen, aSort = [], aoColumns = settings.aoColumns, aDataSort, iCol, sType, srcCol, fixed = settings.aaSortingFixed, fixedObj = $.isPlainObject(fixed), nestedSort = [], add = function(a) {
      ...
      for (i2 = 0; i2 < nestedSort.length; i2++) {
        ...
        for (k = 0, kLen = aDataSort.length; k < kLen; k++) {
          ...
          if (nestedSort[i2]._idx === undefined$1) {
    ...
    _Api.registerPlural = _api_registerPlural = function(pluralName, singularName, val) {
      ...
      _Api.register(singularName, function() {
        ...
        if (ret === this) {
          ...
          return ret.length ? Array.isArray(ret[0]) ? new _Api(ret.context, ret[0]) : ret[0] : undefined$1;
        }
        return ret;
      });
    };
    ...
    _api_register("tables()", function(selector) {
      return selector !== undefined$1 && selector !== null ? new _Api(__table_selector(selector, this.context)) : this;
    });
    ...
    _api_register("page.len()", function(len) {
      if (len === undefined$1) {
        return this.context.length !== 0 ? this.context[0]._iDisplayLength : undefined$1;
      }
      return this.iterator("table", function(settings) {
    ...
    _api_register("row().data()", function(data) {
      var ctx = this.context;
      if (data === undefined$1) {
        return ctx.length && this.length ? ctx[0].aoData[this[0]]._aData : undefined$1;
      }
    ...
    _api_register(_child_mth, function(data, klass) {
      var ctx = this.context;
      if (data === undefined$1) {
        return ctx.length && this.length ? ctx[0].aoData[this[0]]._details : undefined$1;
      } else if (data === true) {
        this.child.show();
      } else if (data === false) {
    ...
    var __cell_selector = function(settings, selector, opts) {
      ...
      var run = function(s) {
        ...
        if ($.isPlainObject(s)) {
          return s.column !== undefined$1 && s.row !== undefined$1 && $.inArray(s.row, rows) !== -1 ? [s] : [];
        }
    ...
    _api_registerPlural("cells().nodes()", "cell().node()", function() {
      return this.iterator("cell", function(settings, row, column) {
        ...
        return data && data.anCells ? data.anCells[column] : undefined$1;
      }, 1);
    });
    ...
    _api_register("cell().data()", function(data) {
      ...
      var cell = this[0];
      if (data === undefined$1) {
        return ctx.length && cell.length ? _fnGetCellData(ctx[0], cell[0].row, cell[0].column) : undefined$1;
      }
    ...
    _api_register("order()", function(order, dir) {
      ...
      if (order === undefined$1) {
        return ctx.length !== 0 ? ctx[0].aaSorting : undefined$1;
      }
    ...
    _api_register("order.fixed()", function(set) {
      if (!set) {
        var ctx = this.context;
        var fixed = ctx.length ? ctx[0].aaSortingFixed : undefined$1;
    ...
    _api_register("search()", function(input, regex, smart, caseInsen) {
      ...
      if (input === undefined$1) {
        return ctx.length !== 0 ? ctx[0].oPreviousSearch.sSearch : undefined$1;
      }
      return this.iterator("table", function(settings) {
    ...
    $.each(["column", "row", "cell"], function(i2, type) {
      _api_register(type + "s().every()", function(fn) {
        ...
        return this.iterator(type, function(settings, arg1, arg2, arg3, arg4) {
          fn.call(api[type](arg1, type === "cell" ? arg2 : opts, type === "cell" ? opts : undefined$1), arg1, arg2, arg3, arg4);
        });
      });
    });
    _api_register("i18n()", function(token, def, plural) {
      ...
      if (plural !== undefined$1 && $.isPlainObject(resolved)) {
        resolved = resolved[plural] !== undefined$1 ? resolved[plural] : resolved._;
      }
