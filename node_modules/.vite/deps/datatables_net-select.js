  ...
  "node_modules/datatables.net-select/js/dataTables.select.js"(exports, module) {
    (function(factory) {
      ...
      DataTable.select.init = function(dt) {
        ...
        var opts = init2 === undefined ? defaults : init2;
        var items = "row";
        var style = "api";
        var blurable = false;
        var toggleable = true;
...
// dep:datatables_net-select
var datatables_net_select_default = require_dataTables_select();
export {
  datatables_net_select_default as default
};
/*! Select for DataTables 1.4.0-dev
 * 2015-2021 SpryMedia Ltd - datatables.net/license/mit
 */
//# sourceMappingURL=datatables_net-select.js.map
